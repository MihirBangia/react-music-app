...
import styles from "../Albums/albumsongs.module.css"; // Import the CSS module
import Player from "../player/player";

export default function ApiPlaylistSongs() {
  ...
  async function getAlbumSongs() {
    let res = await axios.get(
      `https://saavn.me/playlists?id=${location.state.link}`
    );
